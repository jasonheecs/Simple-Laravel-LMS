...
@section('content')
    ...
    <div id="lesson-panel" class="lesson-panel">
        <div class="flex__item flex__item--4 panel panel--default">
            ...
            <div class="panel__content">
                ...
                <div id="lesson-body-content" class="body-editable lesson-content">
                    {!! $lesson->body !!}
                </div>
        ...
        <div class="flex__item flex__item--1 panel panel--default hidden">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam voluptates sed culpa, assumenda. Facilis possimus aliquam fuga, accusantium obcaecati numquam?
        </div>
    </div>
